        ...
        >
          ...
          <div className="relative p-5">
            <div className="flex items-start justify-between mb-4">
              <div className={`inline-flex items-center justify-center rounded-xl bg-gradient-to-br ${it.iconBg} p-3 group-hover:scale-110 transition-transform duration-300`}>
                <it.Icon className={`w-5 h-5 ${it.iconColor}`} strokeWidth={2} />
              </div>
            </div>
            <div className="text-slate-400 text-xs font-medium tracking-wide mb-2">{it.label}</div>
